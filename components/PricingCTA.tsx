...
export default function PricingCTA() {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white ">
      <div className="max-w-5xl mx-auto rounded-3xl bg-green-600 overflow-hidden relative shadow-2xl">
        {/* Decorative elements */}
        ...
        <div className="relative py-16 px-8 text-center sm:px-16">
          <h2 className="text-3xl font-extrabold text-white sm:text-4xl mb-6">
            Et si votre WhatsApp travaillait pour vous dès aujourd’hui ?
          </h2>
          ...
          <div className="flex justify-center">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-[#25D366] group-hover:scale-110 transition-transform">
              ...
              Parler avec un expert sur WhatsApp
            </Link>
          </div>
        </div>
      </div>
